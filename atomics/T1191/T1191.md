...
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1191/src/T1191.inf" -OutFile "#{inf_file_path}"
```
...
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1191/src/T1191_uacbypass.inf" -OutFile "#{inf_file_uac}"
```
