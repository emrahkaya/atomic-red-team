...
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1500/src/calc.cs" -OutFile "#{input_file}"
```
...
##### Get Prereq Commands:
```powershell
Invoke-WebRequest https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1500/bin/T1500_DynamicCompile.exe -OutFile #{input_file}
```
