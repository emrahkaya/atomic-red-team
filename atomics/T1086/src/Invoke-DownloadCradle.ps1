...
ElseIf ($TLS -eq 1){
    ...
    $Url = @(
        "https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1086/payloads/test.ps1", # Basic Powershell Test script
        "test.dfir.com.au", # DNS text test - Powershell Test script base64 encoded in DNS txt field
        "https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1086/payloads/test.xml", # Powershell embedded command
        "https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1086/payloads/test.sct", # Powershell embedded scriptlet
        "https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1086/payloads/mshta.sct", # Powershell embedded scriptlet
        "https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1086/payloads/test.xsl" # Powershell embedded extensible Stylesheet Language
    )
}
...
$Url = "https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1086/payloads/test.ps1"
